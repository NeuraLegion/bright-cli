...
export class CertificatesLoader implements Certificates {
  ...
  private async discoveryDefaultLocations(): Promise<void> {
    ...
    logger.warn(
      `Error Loading Certificate: Cannot load certificates from the system root. Please use "--cacert" option to specify the accurate path to the file. https://docs.brightsec.com/docs/initializing-a-repeater#options`
    );
  }
